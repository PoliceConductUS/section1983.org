...
dateDecided: 1989-02-28
docketNumber: "86-1088"
courtlistener: "https://www.courtlistener.com/opinion/112219/canton-v-harris/"
holding: "A municipality can be liable under § 1983 for failing to train its employees when the failure to train amounts to deliberate indifference to the constitutional rights of persons the employees encounter."
tags:
  - "national"
...
_City of Canton_ opened a crucial pathway for holding cities accountable for systemic failures. Under [_Monell_](/cases/monell-v-dep-t-of-soc-servs), a city isn't liable just because it employs a bad officer. But after _Canton_, a city that fails to train its officers — knowing they'll encounter situations where constitutional rights are at stake — can be held liable for the resulting violations.

The "deliberate indifference" standard is demanding but not impossible. You typically prove it in one of two ways:

1. **Pattern evidence.** Show that officers have repeatedly committed similar violations, putting the city on notice that its training is inadequate. If officers keep violating the same right and the city does nothing to improve training, that's deliberate indifference.
...
_Canton_ is your primary tool for failure-to-train claims against municipalities:
