...
The Fifth Circuit affirmed dismissal, applying the [plausibility pleading](/terms-and-concepts/plausibility-pleading) standard from [_Iqbal_](/cases/ashcroft-v-iqbal) and [_In re Katrina Canal Breaches_](/cases/in-re-katrina-canal-breaches-litig). The court held that the contractual documents must be "read as a whole." While the no-delinquency representations, standing alone, might support a fraud claim, the contracts also contained "repurchase or substitute" clauses providing that if delinquent loans were discovered, Barclays would either repurchase them or substitute performing loans — and this constituted the "sole remedy."
...
The court articulated the Rule 12(b)(6) standard: "The ultimate question in a Rule 12(b)(6) motion is whether the complaint states a valid claim when all well-pleaded facts are assumed true and are viewed in the light most favorable to the plaintiff," citing _In re Katrina Canal Breaches_.

## Why This Case Matters for Your § 1983 Case

While _Lone Star_ is a securities fraud case, it is cited in [§ 1983](/terms-and-concepts/section-1983) litigation for its articulation of the [motion to dismiss](/terms-and-concepts/motion-to-dismiss) standard:

- **Rule 12(b)(6) standard**: The court's formulation — assume well-pleaded facts as true, view them favorably to the plaintiff, determine if the claim is plausible — is cited across Fifth Circuit civil rights cases.
- **Documents control**: When documents attached to or referenced in the complaint tell a different story than the plaintiff's narrative, the documents control. In § 1983 cases, this applies to police reports, policies, body camera transcripts, and other records.
- **Reading agreements as a whole**: If your [§ 1983](/terms-and-concepts/section-1983) case involves a [settlement](/terms-and-concepts/settlement) agreement, release, or consent decree, this case reminds courts to read the entire document — not isolated provisions.
- **Rule 9(b) and fraud**: Claims sounding in fraud must be pled with particularity, which can affect § 1983 cases involving allegations of fraudulent conduct by government officials.

## Key Takeaway

Contractual documents must be read as a whole on a [motion to dismiss](/terms-and-concepts/motion-to-dismiss) — isolated representations cannot be cherry-picked as misrepresentations when the complete agreement provides a remedy for their breach — and the Fifth Circuit applies the same [plausibility](/terms-and-concepts/plausibility-pleading) standard to all Rule 12(b)(6) motions, including those in civil rights cases.
