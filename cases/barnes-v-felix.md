...
Barnes's mother sued Felix on Barnes's behalf under [§ 1983](/terms-and-concepts/section-1983), alleging that Felix violated Barnes's [Fourth Amendment](/terms-and-concepts/fourth-amendment) right to be free from [excessive force](/terms-and-concepts/excessive-force).
...
The Court reaffirmed that [excessive force](/terms-and-concepts/excessive-force) claims are analyzed under the Fourth Amendment's "objective reasonableness" standard from [_Graham v. Connor_](/cases/graham-v-connor). This requires examining the **"totality of the circumstances"** with **"careful attention to the facts and circumstances"** of each case—not an artificially restricted snapshot.
...
The Court cited _Plumhoff v. Rickard_ as a clear example: there, an officer's use of [deadly force](/terms-and-concepts/deadly-force) was justified "at the moment" partly because of what had transpired during a preceding high-speed chase. The prior events provided essential context.
...
**Totality of circumstances is the standard everywhere.** This case confirms that no circuit may adopt a rigid temporal limitation on the [Graham](/cases/graham-v-connor) analysis. Every fact, from the initial encounter through the use of force, is potentially relevant.
