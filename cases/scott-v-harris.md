...
dateDecided: 2007-04-30
docketNumber: "05-1631"
courtlistener: "https://www.courtlistener.com/opinion/145720/scott-v-harris/"
holding: "When video evidence blatantly contradicts the plaintiff's version of events, courts need not adopt the plaintiff's account at summary judgment — and a police officer who rams a fleeing motorist's car to end a dangerous high-speed chase does not violate the Fourth Amendment."
officers:
  - name: "Deputy Timothy Scott"
tags:
  - "national"
  - "beaten-by-police"
  - "body-camera"
...
On the Fourth Amendment question, the Court rejected the idea that [_Garner_](/cases/tennessee-v-garner) created a rigid "deadly force" on/off switch. _Garner_ simply applied the Fourth Amendment's reasonableness test to one set of facts. The proper analysis under [_Graham v. Connor_](/cases/graham-v-connor) is always a balancing of interests: the nature and quality of the intrusion against the governmental interests at stake.
...
_Scott_ is primarily a defense case, but understanding it helps you litigate around it:

- **The video doesn't always tell the whole story.** Challenge the assumption that video evidence is unambiguous. Camera angles are limited, body cameras turn on late, and dashcams don't capture what happened before the recording began. Argue that the video is incomplete or susceptible to multiple interpretations.
- **"Blatantly contradicts" is a high bar.** _Scott_ applies only when the video "blatantly contradicts" the plaintiff's version "so that no reasonable jury could believe it." 550 U.S. at 380. If the video is ambiguous — if reasonable people could disagree about what it shows — the case should go to the jury.
- **Distinguish your chase from _Scott_'s.** Not every pursuit is a ten-mile, 85-mph rampage through traffic. If the chase was short, at moderate speeds, or on empty roads, the risk to the public was lower and the force less justified.
- **Template**: "Unlike the 'blatant[]' contradiction at issue in _Scott v. Harris_, 550 U.S. 372, 380 (2007), the video evidence here is ambiguous and susceptible to multiple reasonable interpretations. A reasonable jury viewing this footage could conclude that [describe plaintiff-favorable interpretation]. Summary judgment is therefore inappropriate."

## How It Can Be Used Against You

_Scott_ is one of the defense's favorite cases:

- **"Watch the tape."** If body camera or dashcam footage exists, the defense will use _Scott_ to argue that the video tells the whole story — and that your version of events is not credible. Courts regularly grant summary judgment on this basis.
- **Deference to high-speed pursuit decisions.** The defense will cite _Scott_ for the broad principle that officers who end dangerous chases don't violate the Fourth Amendment. The more dangerous the chase appears, the more latitude the officer gets.
- **Rejecting the "call off the chase" argument.** Under _Scott_, the court will not require officers to abandon a pursuit and hope the suspect stops on their own. The risk of continuing flight — to the suspect and to the public — justifies intervention.

**How to counter**: Get the video into evidence early and make the court watch it carefully — frame by frame if necessary. Supplement the video with other evidence: witness testimony, expert analysis, the officer's own statements, and the physical evidence. If the video is grainy, shot from a distance, or missing key moments, emphasize its limitations. And remember that _Scott_ applies to summary judgment, not trial. If the video is genuinely ambiguous, push for a jury determination under [_Tolan v. Cotton_](/cases/tolan-v-cotton).
