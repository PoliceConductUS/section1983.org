...
Thousands of property owners in the New Orleans area whose homes were damaged or destroyed by Hurricane Katrina sued their insurance companies. The central dispute was whether the destruction was caused by wind — which was generally covered — or by flooding from the breach of levees and canal walls — which was generally excluded under the policies' water-damage exclusions. The cases were consolidated in a multi-district litigation proceeding before the Eastern District of Louisiana.

The insurers moved to dismiss, arguing that the flood exclusion clauses in their policies barred coverage. The homeowners countered that the "efficient proximate cause" doctrine should apply, meaning that if wind (a covered peril) set in motion the chain of events leading to the flooding, coverage should exist. They also argued the flood exclusions were ambiguous.
