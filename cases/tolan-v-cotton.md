...
dateDecided: 2014-05-05
docketNumber: "13-551"
courtlistener: "https://www.courtlistener.com/opinion/2668959/tolan-v-cotton/"
holding: "Courts ruling on summary judgment must view the facts in the light most favorable to the nonmoving party — the Fifth Circuit erred by crediting the officer's version of disputed facts when denying an excessive force claim."
officers:
  - name: "Sergeant Jeffrey Cotton"
  - name: "Officer John Edwards"
tags:
  - "national"
  - "beaten-by-police"
  - "fourth-amendment"
...
At summary judgment, courts must believe the nonmoving party's evidence and draw all reasonable inferences in their favor. _Anderson v. Liberty Lobby, Inc._, 477 U.S. 242, 255 (1986). The Fifth Circuit didn't do that. Instead, it credited Cotton's version of disputed events and drew inferences against Tolan on multiple critical points.
...
"By failing to credit evidence that contradicted some of its key factual conclusions, the court improperly 'weights the evidence' and resolves disputed issues in favor of the moving party." 572 U.S. at 657 (quoting _Anderson_, 477 U.S. at 249).
...
_Tolan_ also demonstrates that the Supreme Court is willing to intervene when lower courts fail to follow summary judgment rules in qualified immunity cases. The per curiam format — an unsigned opinion with no oral argument — signals that the Court considered the error obvious.

## How You Can Use It

_Tolan_ is essential for opposing summary judgment in excessive force cases:

- **Catalog every factual dispute.** For each material fact, identify the plaintiff's version and the defendant's version. Then show the court that adopting the defendant's version at this stage violates _Tolan_.
- **Key quote**: "In holding that Cotton's actions did not violate clearly established law, the Fifth Circuit failed to view the evidence at summary judgment in the light most favorable to Tolan with respect to the central facts of this case. By failing to credit evidence that contradicted some of its key factual conclusions, the court improperly 'weigh[ed] the evidence.'" 572 U.S. at 657.
- **Pair with [_Graham v. Connor_](/cases/graham-v-connor).** The _Graham_ reasonableness factors depend on the facts. If the facts are disputed, those disputes must be resolved in the plaintiff's favor at summary judgment. Tolan's version of the facts — unarmed, on his knees, reacting to his mother being slammed — tells a very different story than Cotton's version.
- **Template**: "Under _Tolan v. Cotton_, 572 U.S. 650 (2014), this Court must view the evidence in the light most favorable to Plaintiff and credit Plaintiff's version of disputed facts. The defense's motion improperly asks this Court to adopt Defendant's account of [specific disputed fact], which directly contradicts Plaintiff's sworn testimony."

## How It Can Be Used Against You

_Tolan_ doesn't prevent summary judgment — it just enforces the rules:

- **Undisputed facts still control.** Where the facts aren't genuinely disputed — or where video evidence contradicts the plaintiff's version (see [_Scott v. Harris_](/cases/scott-v-harris)) — the court can grant summary judgment.
- **"Even under plaintiff's version."** The strongest defense at summary judgment is to argue that even taking every fact in the plaintiff's favor, the officer's conduct was reasonable. If the force was justified even under the plaintiff's best version of events, _Tolan_ doesn't save the case.

**How to counter**: Make sure your summary judgment record includes detailed sworn testimony — depositions, declarations, affidavits — from the plaintiff and every favorable witness. Photographs, medical records, and any available video should be in the record. The more evidence you have supporting your version of events, the harder it is for the court to grant summary judgment without violating _Tolan_.
