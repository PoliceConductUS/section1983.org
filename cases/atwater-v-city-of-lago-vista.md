...
dateDecided: 2001-04-24
docketNumber: "99-1408"
courtlistener: "https://www.courtlistener.com/opinion/118393/atwater-v-city-of-lago-vista/"
holding: "The Fourth Amendment does not forbid a warrantless custodial arrest for a minor criminal offense — even a misdemeanor punishable only by a fine — as long as the officer has probable cause."
officers:
  - name: "Officer Bart Turek"
tags:
  - "national"
  - "arrested-for-speech"
  - "beaten-by-police"
...
_Atwater_ is devastating for § 1983 plaintiffs challenging arrests. It means an officer who has probable cause to believe you committed _any_ criminal offense — no matter how minor — can constitutionally handcuff you, take you to jail, book you, and lock you in a cell. There is no constitutional proportionality requirement between the severity of the offense and the intrusiveness of the arrest.

This creates enormous power for officers to make pretextual arrests. Combined with _Whren v. United States_ (1996) — which held that officers' subjective motivations are irrelevant to Fourth Amendment analysis — an officer can arrest anyone for virtually any minor infraction as a pretext for another purpose.
...
- **"Extraordinary manner" exception**: If your arrest involved unusual force, prolonged detention, public humiliation beyond standard booking, or physical harm, argue that _Atwater_ left open the possibility of relief for arrests conducted in an "extraordinary manner." 532 U.S. at 354.
- **State law limitations**: Many states impose stricter limits than the Constitution. Texas and other states have statutes requiring citation in lieu of arrest for certain minor offenses. Even if the arrest is constitutional under _Atwater_, it may violate state law — which can support related claims.
- **Retaliatory arrest claims**: If the arrest was motivated by retaliation for protected speech, _Atwater_ doesn't help the defense. A retaliatory-arrest claim under [_Gonzalez v. Trevino_](/cases/gonzalez-v-trevino) is a separate analysis.
- **Distinguish pretextual arrests**: While _Atwater_ allows the arrest, combining it with evidence of discriminatory or retaliatory motive may support equal protection or First Amendment claims.

## How It Can Be Used Against You

- **Blanket authority**: Defendants will cite _Atwater_ for the proposition that any arrest supported by probable cause is constitutional, full stop. No balancing of interests, no proportionality analysis.
- **Kills many § 1983 false arrest claims**: If the officer had probable cause for _any_ offense — even jaywalking — the arrest is constitutional under _Atwater_, regardless of whether the officer had a different real motive.
- **Standard booking procedures**: The "extraordinary manner" exception is very narrow. Standard handcuffing, transport, booking, and brief cell time — all of which Atwater endured — were held _not_ extraordinary.

**How to counter**: Focus on what makes your arrest _different_ from a routine booking. Excessive force during the arrest, unusually long detention, strip searches for minor offenses, or denial of medication can cross the "extraordinary manner" line. Also explore state-law claims — many jurisdictions limit arrest authority for minor offenses by statute.
