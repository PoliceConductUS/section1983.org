---
title: "Davenport v. City of Garland, Texas"
citation: "No. 3:09-CV-798-B (N.D. Tex. 2010)"
court: "United States District Court for the Northern District of Texas"
dateDecided: 2010-04-09
docketNumber: "3:09-CV-798-B"
holding: "A prisoner's § 1983 excessive force claims against a city were dismissed for failure to plead any facts identifying the final policymaker, showing a pattern of similar violations, or establishing a direct causal link between a municipal policy or custom and the constitutional violation."
tags: []
cites:
...
Applying [_Monell v. Department of Social Services_](/cases/monell-v-dep-t-of-soc-servs) and [_Piotrowski v. City of Houston_](/cases/piotrowski-v-city-of-houston), the court identified what Davenport needed but failed to provide:
...
The court applied [_Twombly_](/cases/bell-atlantic-corp-v-twombly) and [_Iqbal_](/cases/ashcroft-v-iqbal), emphasizing that conclusory allegations — like "the City has a code of silence" — are not entitled to the assumption of truth. Having given Davenport multiple opportunities to amend, the court dismissed with prejudice.

## Why This Case Matters for Your § 1983 Case

Davenport v. City of Garland is a roadmap of what not to do when suing a city:

- **Name the policymaker.** You must identify who in the city has final authority over the relevant policy area — the chief of police, the city council, a civil service commission.

- **Allege prior incidents.** A custom requires a pattern. You need to identify prior complaints, lawsuits, or incidents of similar misconduct.

- **Provide facts, not conclusions.** Saying "the city has a custom of excessive force" is a legal conclusion. You need facts: dates, names, descriptions of prior incidents.

- **Show the causal link.** Explain how the specific policy or custom caused your injury. A "but for" connection is not enough — it must be a direct, moving-force causation.

- **Amend carefully.** Courts will give you chances to fix your complaint, but each amendment must add new facts. Repeating the same conclusory allegations will result in dismissal with prejudice.
