---
title: "Ryan v. Lopez"
citation: "No. 24-40299 (5th Cir. 2025)"
court: "United States Court of Appeals for the Fifth Circuit"
dateDecided: 2025-06-09
docketNumber: "24-40299"
holding: "Officers were entitled to qualified immunity where they used force during a traffic stop after the plaintiff physically resisted arrest, even though the initial stop may have been pretextual."
tags:
  - "louisiana"
  - "mississippi"
  - "texas"
...
This case involves a [§ 1983](/terms-and-concepts/section-1983) excessive force claim arising from a traffic stop in which officers used force to subdue a driver who physically resisted arrest. The Fifth Circuit addressed whether the officers were entitled to [qualified immunity](/terms-and-concepts/qualified-immunity) for their use of force during the encounter. The court found that the officers' actions were not objectively unreasonable under the circumstances.

## The Facts

Officers conducted a traffic stop on the plaintiff, Ryan. During the encounter, the situation escalated and officers attempted to place Ryan under arrest. Ryan physically resisted the officers' efforts to restrain and handcuff him. The officers used force to overcome his resistance and complete the arrest. Ryan subsequently filed a [§ 1983](/terms-and-concepts/section-1983) lawsuit alleging the officers used [excessive force](/terms-and-concepts/excessive-force) in violation of his [Fourth Amendment](/terms-and-concepts/fourth-amendment) rights.

The officers moved for summary judgment based on qualified immunity.

## What the Court Decided

The Fifth Circuit held that the officers were entitled to qualified immunity. Applying the [Graham v. Connor](/cases/graham-v-connor) factors, the court examined the severity of the crime at issue, whether the suspect posed an immediate threat to the safety of officers or others, and whether he was actively resisting arrest.
...
The court also found that even if the constitutional violation were established, the right at issue was not [clearly established](/terms-and-concepts/clearly-established-law) with sufficient specificity to put the officers on notice that their conduct was unlawful under the particular circumstances they faced.
...
**Pretextual stops do not automatically make force excessive.** Even if a traffic stop was arguably pretextual, the [excessive force](/terms-and-concepts/excessive-force) analysis focuses on the moment force was used and the circumstances at that time, not on the officer's initial motivation for the stop.
