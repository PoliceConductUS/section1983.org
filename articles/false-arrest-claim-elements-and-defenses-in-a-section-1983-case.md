---
title: "False Arrest Claim Elements and Defenses in a § 1983 Case"
description: "Learn the elements of a Section 1983 false arrest claim, the main probable-cause defenses, and how false arrest cases usually fail or survive."
pubDate: 2026-02-11
author: "Institute for Police Conduct, Inc."
tags: ["false-arrest", "probable-cause", "fourth-amendment", "defenses"]
draft: false
---
...
1. the defendant seized or arrested you
2. the arrest lacked probable cause
3. you suffered a compensable injury, even if the detention was brief
...
This often becomes a combined [false arrest](/terms-and-concepts/false-arrest) and [First Amendment retaliation](/terms-and-concepts/first-amendment-retaliation) case. The key questions are:
...
Even if the arrest looks weak, the officers will usually argue [qualified immunity](/terms-and-concepts/qualified-immunity): that a reasonable officer could have believed probable cause existed. This is where factual specificity matters.
...
If the offense was [public intoxication](/terms-and-concepts/probable-cause), for example, you should not stop at "I was not drunk." You should also ask:
...
If you were convicted of the offense for which you were arrested, or of a related offense whose validity would be undermined by your civil claim, the [Heck doctrine](/terms-and-concepts/heck-doctrine) may bar the case unless the conviction has been invalidated.
