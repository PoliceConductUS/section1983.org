---
title: "How to Write a § 1983 Complaint"
description: "Learn how to write a Section 1983 complaint that identifies the right defendants, pleads specific facts, and survives an early motion to dismiss."
pubDate: 2026-02-01
author: "Institute for Police Conduct, Inc."
tags: ["complaint", "filing", "pleading", "pro-se"]
draft: false
---

If you are drafting your first [Section 1983](/terms-and-concepts/section-1983) complaint, read this with [how to name your defendants](/articles/how-to-name-defendants-in-a-section-1983-lawsuit) and [how to stress-test your case before filing](/articles/how-to-stress-test-your-case-before-filing).
...
- **Capacity**: [individual capacity](/terms-and-concepts/individual-capacity), [official capacity](/terms-and-concepts/official-capacity), or both.
...
- **Count I**: [Excessive force](/terms-and-concepts/excessive-force) in violation of the Fourth Amendment (against Officer Smith in [individual capacity](/terms-and-concepts/individual-capacity))
- **Count II**: [First Amendment retaliation](/terms-and-concepts/first-amendment-retaliation) (against Officer Smith in individual capacity)
- **Count III**: [Monell liability](/terms-and-concepts/monell-liability) — failure to train/supervise (against the City)

For each count, identify:

1. The specific constitutional right violated
2. The specific defendant
...
- **Failure to train**: The department knew officers were violating rights in a specific way and failed to provide adequate training. See [_City of Canton v. Harris_](/cases/city-of-canton-v-harris).
...
- **[Final policymaker](/terms-and-concepts/final-policymaker)**: A person with final decision-making authority made the specific decision that caused your injury.
...
The [plausibility standard](/terms-and-concepts/plausibility-pleading) requires facts, not labels.
...
Before [filing](/process/filing), check each item below:

**For each claim:**

- [ ] Identified the specific constitutional right at issue
- [ ] Named the specific defendant(s) — by name, not just "the officers"
- [ ] Specified [individual](/terms-and-concepts/individual-capacity) and/or [official capacity](/terms-and-concepts/official-capacity)
...
- [ ] Connected the policy to a [final policymaker](/terms-and-concepts/final-policymaker) (for policy claims) or showed [deliberate indifference](/terms-and-concepts/deliberate-indifference) (for failure-to-train claims)

**Procedural:**

- [ ] Filed in the correct court (usually where the incident occurred)
- [ ] Within the [statute of limitations](/terms-and-concepts/statute-of-limitations)
...
_This is an educational resource, not legal advice. Adapt everything to your specific situation and your state's laws. When in doubt, consult an attorney — even a single consultation to review your complaint before filing can be worth the cost. Then read [why no lawyer will take your § 1983 case](/articles/why-no-lawyer-will-take-your-section-1983-case) and [You Will Probably Lose. You Might Sue Anyway. Here's Why That Still Matters.](/articles/you-will-probably-lose-you-might-sue-anyway-heres-why-that-still-matters) so you go in with realistic expectations._
