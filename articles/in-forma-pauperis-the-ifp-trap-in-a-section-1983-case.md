---
title: "In Forma Pauperis: The IFP Trap in a § 1983 Case"
description: "Learn what in forma pauperis means, what screening it triggers, how the IFP trap can kill a Section 1983 case before service, and what to get right before you file."
pubDate: 2026-01-31
author: "Institute for Police Conduct, Inc."
tags: ["ifp", "filing", "getting-started", "pro-se"]
draft: false
---

If you cannot afford the federal filing fee, one of the first choices you may face is whether to apply to proceed [in forma pauperis](/terms-and-concepts/in-forma-pauperis), usually shortened to `IFP`.
...
- identify what `IFP` does and what it triggers
- spot the screening risk before you file
- decide what has to be true about your complaint before `IFP` is worth the risk

Read this before [How to Write a § 1983 Complaint](/articles/how-to-write-a-section-1983-complaint) and together with [The Process: Filing Your Case](/process/filing). The process page tells you where this fits. This article explains why it can become a trap.
...
- a financial affidavit showing income, assets, expenses, and debts
...
1. If you file `IFP`, what is the first extra risk you take that a paying plaintiff usually does not: early judicial screening, a jury trial, or mandatory settlement?
   <details>
     <summary>Show answer</summary>
     Early judicial screening. That is the main `IFP` trap this article is trying to teach.
   </details>

2. If your complaint still groups all defendants together and does not explain who did what, what is the smarter move before filing `IFP`: file now and hope the judge sorts it out, or fix the complaint first?
   <details>
     <summary>Show answer</summary>
     Fix the complaint first. `IFP` screening is exactly the wrong time to hand the court a vague complaint.
   </details>

3. Think about your own case. Is the real problem money, complaint quality, or both?
   <details>
     <summary>Show answer</summary>
