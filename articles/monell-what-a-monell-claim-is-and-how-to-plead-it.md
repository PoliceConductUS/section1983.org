---
title: "Monell: What a Monell Claim Is and How to Plead It"
description: "A practical guide to pleading Monell claims against a city or county: which theories survive, what facts you need before discovery, and how to use public records to build a real municipal-liability case."
pubDate: 2026-02-15
author: "Institute for Police Conduct, Inc."
tags: ["monell", "municipal-liability", "complaint", "public-records", "policy"]
draft: false
---
...
This guide should be read with [Monell liability](/terms-and-concepts/monell-liability), [FOIA and Records Requests](/process/foia-and-records-requests), [how to write a § 1983 complaint](/articles/how-to-write-a-section-1983-complaint), and the [sample § 1983 complaint](/articles/sample-section-1983-complaint-for-a-false-arrest-case).
...
4. a failure to train, supervise, discipline, or investigate that amounts to [deliberate indifference](/terms-and-concepts/deliberate-indifference)
...
3. [Monell: Failure-to-Train Claims](/articles/monell-failure-to-train-claims)
4. [Monell: Custom or Practice Claims](/articles/monell-custom-or-practice-claims)
5. [Monell: Who Is the Final Policymaker?](/articles/monell-who-is-the-final-policymaker)
6. [Monell: Why Claims Get Dismissed at Rule 12](/articles/monell-why-claims-get-dismissed-at-rule-12)
...
1. identify each Monell theory separately
2. list the facts supporting that theory
3. explain how that theory caused your injury
...
- [PACER](/terms-and-concepts/pacer) and CourtListener for prior cases
...
Why? Because after _City of Canton_ and _Connick_, failure-to-train claims usually need facts showing:
...
1. show a pattern
2. show notice
3. identify a policymaker or policy
...
1. state the underlying constitutional violation
2. identify the municipality
3. identify each Monell theory in a separate subsection or paragraph group
4. allege the supporting facts for each theory
5. allege notice where required
6. allege causation clearly
...
- If this count were attacked under [Iqbal](/cases/ashcroft-v-iqbal), what concrete facts would the judge see?
