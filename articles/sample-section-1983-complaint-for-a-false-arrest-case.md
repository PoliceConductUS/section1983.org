---
title: "Sample § 1983 Complaint for a False Arrest Case"
description: "A practical sample Section 1983 complaint for a false arrest case, with annotated guidance on parties, facts, claims, and Monell allegations."
pubDate: 2026-02-03
author: "Institute for Police Conduct, Inc."
tags: ["sample", "complaint", "false-arrest", "drafting", "monell"]
draft: false
---
...
- how to separate individual-officer claims from [municipal liability](/terms-and-concepts/monell-liability) allegations
...
- no probable cause
- brief detention
- no conviction that would trigger the [Heck doctrine](/terms-and-concepts/heck-doctrine)
...
3. what the officer said
4. what the officer did
5. what happened after the arrest

That sequence makes the [probable cause](/terms-and-concepts/probable-cause) problem easy to see.

### Separate the officer claims from the city claim

The false arrest count and the [First Amendment retaliation](/terms-and-concepts/first-amendment-retaliation) count are about what the officers did. The [Monell](/terms-and-concepts/monell-liability) count is about what the city caused through policy, custom, or deliberate indifference. If you blur those together, the defense will call the complaint conclusory.
...
If you do not have those materials yet, start with [FOIA and Records Requests](/process/foia-and-records-requests).
