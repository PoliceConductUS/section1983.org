---
title: "Damages and How to Document Them in a § 1983 Case"
description: "Learn what damages you can claim in a Section 1983 case, what records actually prove them, and how to tell whether the case is worth the fight."
pubDate: 2026-03-15
author: "Institute for Police Conduct, Inc."
tags: ["damages", "getting-started", "filing", "evidence"]
draft: false
---
...
Read this after [why no lawyer will take your § 1983 case](/articles/why-no-lawyer-will-take-your-section-1983-case) and before [how to write a § 1983 complaint](/articles/how-to-write-a-section-1983-complaint). The first article explains why damages affect the economics of the case. This article shows you how to prove them.
...
- [compensatory damages](/terms-and-concepts/compensatory-damages) for actual harm
- [nominal damages](/terms-and-concepts/nominal-damages) if the violation happened but you cannot prove much loss
- [punitive damages](/terms-and-concepts/punitive-damages) against individual officers for especially bad behavior
...
If you were in custody, remember the [PLRA](/terms-and-concepts/plra) can limit some emotional-distress recovery for prisoner claims without physical injury. If that may apply to you, check it early.
...
[Punitive damages](/terms-and-concepts/punitive-damages) are different. They are about punishment and deterrence, not just compensation.
...
But remember the basic limit: cities do not pay punitive damages under [_City of Newport v. Fact Concerts, Inc._](/cases/city-of-newport-v-fact-concerts-inc). Punitive damages are about the individual defendant.

## Nominal damages are real, but they do not solve the whole problem

If you prove the violation but not much actual loss, you may still get [nominal damages](/terms-and-concepts/nominal-damages).

That matters. It means the right was violated.

But it does not solve the economics problem. [_Farrar v. Hobby_](/cases/farrar-v-hobby) is one reason low-damages cases are hard to litigate. A technical win with tiny damages may still leave you with very little practical leverage.
...
1. This article teaches that the first damages number that matters is not the one you feel is fair. It is the one you can prove. In your own case, which two damages categories are strongest right now, and what records prove them?
   <details>
     ...
     A strong answer names two specific categories and the records behind them, such as urgent-care bills and pay stubs, or booking records and therapy notes.
   </details>
...
2. Which part of your damages file is weakest right now: medical proof, lost wages, emotional distress, property loss, or jail-time documentation? What is the first document you need to fix that?
   <details>
     <summary>Show answer</summary>
     A strong answer identifies one weak category and one next document, such as employer confirmation of missed work, a therapy intake note, booking records, or replacement receipts.
   </details>
...
3. If the defense tried to minimize your case tomorrow, what would be their easiest damages argument: no treatment, no records, preexisting problems, exaggeration, or low-dollar harm? What fact or document can you use to answer it?
   <details>
     <summary>Show answer</summary>
     A strong answer names the defense's easiest attack and one concrete answer, such as a treatment record, timeline, wage document, or witness who saw the change.
   </details>
