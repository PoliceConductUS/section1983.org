---
title: "Statute of Limitations and Tolling in a § 1983 Case"
description: "Learn when the filing clock starts in a Section 1983 case, how tolling can pause it, and how to avoid losing a viable claim by waiting too long."
pubDate: 2026-03-14
author: "Institute for Police Conduct, Inc."
tags: ["statute-of-limitations", "tolling", "filing", "getting-started"]
draft: false
---
...
Read this before [How to Write a § 1983 Complaint](/articles/how-to-write-a-section-1983-complaint) and alongside [How to Stress-Test a § 1983 Case Before Filing](/articles/how-to-stress-test-your-case-before-filing). If the deadline has already run, the rest of the drafting work may not matter.
...
- `You knew about the injury on the day it happened.`
- `This claim accrued years ago.`
- `Nothing tolled the deadline.`
- `You waited too long and the case is time-barred.`
...
1. what deadline length does your state use?
2. when did the clock start running on your claim?
...
- a [false arrest](/terms-and-concepts/false-arrest) claim usually points to the arrest date
- an [excessive force](/terms-and-concepts/excessive-force) claim usually points to the force date
...
- some claims affected by the [Heck doctrine](/terms-and-concepts/heck-doctrine)
...
[Tolling](/terms-and-concepts/tolling) means the clock stops for a while or starts later under a specific rule.
...
- another may be delayed by [Heck](/articles/heck-when-a-section-1983-claim-is-barred)
...
1. the state where the events happened
2. the state's personal-injury limitations period
3. the event date
4. the date you think the claim accrued
5. any tolling theory you think may apply
6. the last filing date under your current best calculation
...
1. If your arrest happened on one date, but a different claim depends on the criminal case ending in your favor later, should you assume every claim in the case has the same filing deadline?
   <details>
     <summary>Show answer</summary>
     No. Different claims can accrue at different times. You need to analyze the deadline claim by claim.
   </details>

2. If you are hoping tolling saves a late claim, what is the safer assumption before you file: that the court will probably give it to you, or that you need specific facts and a real legal basis for it?
   <details>
     <summary>Show answer</summary>
     You need specific facts and a real legal basis. Courts usually treat tolling as a narrow exception, not a routine favor.
   </details>

3. What is the first deadline document you should build for yourself before drafting the complaint: a damages spreadsheet, a list of angry facts, or a claim-by-claim timeline with accrual and tolling notes?
   <details>
     <summary>Show answer</summary>
