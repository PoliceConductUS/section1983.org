---
title: "How Courts Cut Back Section 1983 with Court-Made Rules"
description: "Section 1983 says people who violate constitutional rights shall be liable. Courts later added major barriers not written in the statute. This article explains what that means and why it matters."
pubDate: 2026-01-21
author: "Institute for Police Conduct, Inc."
tags: ["history", "court-made-rules", "qualified-immunity", "absolute-immunity"]
draft: false
---

If you read [Section 1983](/terms-and-concepts/section-1983) itself, the statute is broad on purpose.
...
- `This limitation is necessary to make the system work.`
...
[_Monell v. Department of Social Services_](/cases/monell-v-dep-t-of-soc-servs) is more complicated because it opened one door and narrowed another.

Before _Monell_, cities were largely off the table as defendants under § 1983. _Monell_ allowed municipal liability.
...
- in [_Tower v. Glover_](/cases/tower-v-glover), the Court refused to give public defenders immunity for intentional conspiratorial misconduct under § 1983
- in [_Wyatt v. Cole_](/cases/wyatt-v-cole), the Court refused to give private parties qualified immunity when they used a state procedure later held unconstitutional
- in [_Jama v. Immigration and Customs Enforcement_](/cases/jama-v-immigration-and-customs-enforcement), the Court used the opposite textual rule and said it should not lightly assume Congress omitted a requirement it still meant to apply
...
1. If a barrier does not appear in the text of § 1983, does that automatically mean courts cannot enforce it today?
   <details>
...
2. What is the key difference this article is trying to teach: the difference between federal and state court, or the difference between what § 1983 says and the extra barriers courts added later?
   <details>
     <summary>Show answer</summary>
