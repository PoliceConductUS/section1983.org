---
title: "How to Write a Declaration in a § 1983 Case"
description: "Learn how to write a sworn declaration for a Section 1983 case, including the required format, common mistakes, and a declaration template you can adapt."
pubDate: 2026-02-21
author: "Institute for Police Conduct, Inc."
tags: ["declarations", "evidence", "summary-judgment", "pro-se"]
draft: false
---

If you are already drafting motions or preparing for [summary judgment](/process/summary-judgment), read this together with [how to write a § 1983 complaint](/articles/how-to-write-a-section-1983-complaint). Your complaint starts the case; your declaration helps keep it alive when facts are disputed.
...
Declarations are how you put facts before a judge when there's no trial happening yet. If the defense files a [motion for summary judgment](/process/summary-judgment) claiming there's no genuine dispute about what happened, your declaration is how you say: _Actually, here's what happened, in my own words, under oath._

## When you need a declaration in federal court

You'll most likely need a declaration when:

- **Opposing [summary judgment](/process/summary-judgment)** — the defense will argue there are no disputed facts. Your declaration creates those disputes by presenting your version of events under oath.
- **Supporting your own motions** — if you're asking the court for something (a temporary restraining order, a motion to compel [discovery](/terms-and-concepts/discovery)), you may need to establish facts through a declaration.
...
The most common mistake. Your declaration should describe _what happened_ — not what it means legally.
...
- "As shown in the [body camera footage](/terms-and-concepts/body-camera-footage) (Exhibit A) at timestamp 03:12, Officer Smith struck me while I was face-down on the ground."
...
If you have [BWC footage](/terms-and-concepts/body-camera-footage), build your declaration around its timestamps. This creates a paragraph-by-paragraph account that a judge can verify against the video. It's hard to dismiss a declaration that tracks the footage frame by frame.
...
>
> 1. I am the Plaintiff in this action. I am over 18 years of age and competent to testify to the matters stated herein. I have personal knowledge of the facts set forth in this declaration.
> 2. On **[date]**, at approximately **[time]**, I was **[describe what you were doing and where — be specific]**.
> 3. **[Continue with numbered paragraphs, one fact per paragraph. Be specific. Include timestamps where available. Reference documents or footage where applicable: "As shown in Officer Smith's body camera footage at timestamp 03:12, ..."]**
...
_This is an educational resource, not legal advice. Adapt the template to your specific situation. Before you file it, compare it against the [summary-judgment stage](/process/summary-judgment) and the [discovery stage](/process/discovery) so you understand how the declaration will be used._
