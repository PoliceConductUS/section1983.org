---
title: "How to Name Defendants in a § 1983 Lawsuit"
description: "Learn how to choose and order defendants in a Section 1983 complaint so the right officer is searchable, accountable, and properly sued."
pubDate: 2026-02-07
author: "Institute for Police Conduct, Inc."
tags: ["complaint", "strategy", "getting-started"]
draft: false
---

Your case name is permanent. The moment you file your complaint, the first defendant's name becomes part of the public record — in PACER, in <a href="https://www.courtlistener.com/" target="_blank" rel="noopener">CourtListener ↗</a>, in Google Scholar, in every database that indexes federal litigation. Journalists, future plaintiffs, hiring managers at other police departments — anyone who searches that officer's name will find your case.

That makes defendant ordering a strategic choice, not an administrative one. If you have not read [who you cannot sue under § 1983](/articles/who-you-cannot-sue-under-section-1983), do that before finalizing your caption. Then compare your draft caption to the [sample Section 1983 complaint for a false arrest case](/articles/sample-section-1983-complaint-for-a-false-arrest-case) so you can see what this looks like in a real pleading.
...
If Officer Martinez arrested you without [probable cause](/terms-and-concepts/probable-cause) while you were recording police from a public sidewalk, your case should be **[Your Name] v. Martinez** — not [Your Name] v. City of Wherever.

The city goes in the caption too — you need the municipality for [Monell liability](/terms-and-concepts/monell-liability). But it goes _after_ the individual officers. If you are unsure whether you have enough to name the city at all, read [Monell: What a Monell Claim Is and How to Plead It](/articles/monell-what-a-monell-claim-is-and-how-to-plead-it) before you add it.

### The practical ordering rule

1. **The primary violator** — the officer most responsible for the main constitutional violation. This becomes your case name.
2. **Other officers directly involved** — backup officers who participated, officers who used force, officers who [failed to intervene](/terms-and-concepts/failure-to-intervene).
3. **Supervisors** — if you have [individual capacity](/terms-and-concepts/individual-capacity) claims against supervisors (they directed the conduct, knew about it and were deliberately indifferent, etc.).
4. **The municipality** — for Monell claims (policy, custom, failure to train/supervise).
...
**Who has the most concerning history?** If you obtained [complaint data or use-of-force statistics](/process/foia-and-records-requests) during preparation, you may know that one officer is a statistical outlier. That officer's name in a case caption creates the most public accountability value.
...
- **<a href="https://www.courtlistener.com/" target="_blank" rel="noopener">CourtListener ↗</a>** — free public legal database (install the <a href="https://free.law/recap" target="_blank" rel="noopener">RECAP extension ↗</a> to contribute your filings)
...
- **[Statute of limitations](/terms-and-concepts/statute-of-limitations)**: Some circuits toll (pause) the limitations period for Doe defendants until you learn the real name. Others don't. If your circuit doesn't toll, the SOL can expire before you identify the officer — and your claim against them dies.
- **Service**: You can't [serve process](/process/service) on "John Doe." Until you identify and serve the real person, the case isn't really pending against them.
...
**Get the real names fast.** [FOIA requests](/process/foia-and-records-requests) for incident reports, dispatch logs, and body camera footage should identify every officer present. If the agency won't tell you who was at the scene, that obstruction itself becomes relevant evidence.
...
**Consider which name you most want searchable.** If you're suing three officers and one of them has a history of [excessive force](/terms-and-concepts/excessive-force) complaints, that officer as Defendant #1 creates the most accountability value.

**Name every officer who participated.** Even officers who "just stood there" may be liable under [failure to intervene](/terms-and-concepts/failure-to-intervene) doctrine. Every name you include is a name in the public record. Officers who watched a colleague violate your rights and did nothing deserve to have that recorded.
