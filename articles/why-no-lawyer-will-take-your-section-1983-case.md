---
title: "Why No Lawyer Will Take Your § 1983 Case"
description: "Civil rights lawyers reject most Section 1983 cases for economic reasons, qualified immunity risk, and low expected damages. Here is what that means for your options."
pubDate: 2026-01-24
author: "Institute for Police Conduct, Inc."
tags: ["getting-started", "reality-check", "attorney-fees", "economics"]
draft: false
---
...
If you are trying to understand why lawyers reject most [Section 1983](/terms-and-concepts/section-1983) cases, the answer is usually math.
...
- the officer had [qualified immunity](/terms-and-concepts/qualified-immunity)
- there was [probable cause](/terms-and-concepts/probable-cause)
- the damages are too small
- the city is not liable under [Monell](/terms-and-concepts/monell-liability)

And the judge may dismiss the case at the motion-to-dismiss stage or at [summary judgment](/terms-and-concepts/summary-judgment), long before any trial.
...
A typical § 1983 case requires 500 to 2,000+ hours of attorney time — researching, drafting motions, fighting [discovery](/terms-and-concepts/discovery) battles, taking [depositions](/terms-and-concepts/deposition), preparing for trial. At even $300/hour, that's $150,000 to $600,000 in time investment the lawyer is risking.

Your damages? If you were wrongfully arrested and spent a few hours in jail with no physical injury, realistic damages might be $5,000 to $25,000. Maybe less. The lawyer is risking $300,000 in time for a _chance_ at recovering $25,000 in damages plus fees — and the fees only come if you win, and then the city fights the fee amount too.

The lawyer is also trying to estimate how likely the case is to survive each stage:

_Chance of surviving the [motion to dismiss](/terms-and-concepts/motion-to-dismiss) × chance of surviving [summary judgment](/terms-and-concepts/summary-judgment) × chance of beating [qualified immunity](/terms-and-concepts/qualified-immunity) × chance of winning at trial × likely damages × chance of actually collecting fees._

If any one of those factors is low, the case may stop making economic sense for the lawyer. [Qualified immunity](/terms-and-concepts/qualified-immunity) alone makes the chance of surviving summary judgment low enough to kill many cases before the math even gets to trial.
...
This is a nightmare scenario for many civil rights lawyers: you prove the violation happened, a jury agrees with you, and you still do not get paid. Cities know this. Their defense strategy often focuses on minimizing your damages so the fee recovery does not justify the risk, even if they cannot seriously dispute the constitutional violation itself.
...
- **[First Amendment retaliation](/terms-and-concepts/first-amendment-retaliation) without tangible consequences** — you were threatened or intimidated but nothing "happened"
...
**Go [pro se](/terms-and-concepts/pro-se).** Represent yourself. It's brutally hard, and the odds are long, but you have a constitutional right to access the courts. Start with [how to stress-test your case before filing](/articles/how-to-stress-test-your-case-before-filing), [how to write your complaint](/articles/how-to-write-a-section-1983-complaint), the [sample Section 1983 complaint for a false arrest case](/articles/sample-section-1983-complaint-for-a-false-arrest-case), and the [legal process guide](/process) so you do not start from zero.
...
- Is [qualified immunity](/terms-and-concepts/qualified-immunity) likely to dominate the case?
- Is there a [Monell](/terms-and-concepts/monell-liability) angle that changes the value?
...
[§ 1983](/terms-and-concepts/section-1983) exists to enforce constitutional rights. [§ 1988](/terms-and-concepts/section-1988) exists to make it economically viable for lawyers to bring those cases. Together, they're supposed to mean that when the government violates your rights, you have a meaningful remedy.

In practice, [qualified immunity](/terms-and-concepts/qualified-immunity) + [Iqbal/Twombly](/terms-and-concepts/plausibility-pleading) + the damages math have gutted that promise for many cases. The result is a large set of constitutional violations that may be real, but that no one is willing or able to litigate.
...
1. If a lawyer says your case is "not economically viable," what is that usually telling you about the case: that the lawyer sees too much economic risk, or that no constitutional violation happened?
   <details>
...
3. If your damages are modest, what facts in your own record could still make the case more attractive to a lawyer? Write down the two strongest ones.
   <details>
     <summary>Show answer</summary>
...
_Published by the [Institute for Police Conduct, Inc.](https://policeconduct.org) This is not legal advice. For more, see [section1983.org](https://section1983.org)._
