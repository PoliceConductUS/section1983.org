...
description: "The defendant's first attack — arguing your complaint fails to state a claim, before any evidence is exchanged."
category: "procedure"
related:
...
Under [Iqbal/Twombly](/terms-and-concepts/plausibility-pleading), the court:

1. **Strips out legal conclusions** — "Defendant violated my rights" gets ignored
2. **Accepts well-pleaded facts as true** — "Officer Smith handcuffed me while I stood with my hands raised" is accepted
3. **Asks whether a plausible claim remains** — Can a reasonable person infer liability from these facts?

## The QI Double Hit

In § 1983 cases, defendants often combine 12(b)(6) with a [qualified immunity](/terms-and-concepts/qualified-immunity) argument. This means the court evaluates:

1. Did you plausibly allege a constitutional violation? (Iqbal/Twombly)
2. Was the right clearly established? (QI)

Both hurdles at the pleading stage, before discovery. It's the most dangerous moment in your case.

## How to Survive

- **Be specific in your complaint**: The more factual detail, the harder to dismiss. See [Plausibility Pleading](/terms-and-concepts/plausibility-pleading).
...
- [Ashcroft v. Iqbal, 556 U.S. 662 (2009)](https://www.courtlistener.com/opinion/145875/ashcroft-v-iqbal/) — The plausibility standard applied at 12(b)(6)
- [Bell Atlantic Corp. v. Twombly, 550 U.S. 544 (2007)](https://www.courtlistener.com/opinion/145730/bell-atlantic-corp-v-twombly/) — "Plausibility" replaces "no set of facts"
