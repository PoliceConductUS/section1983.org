...
title: "Answer"
term: "Answer"
description: "The defendant's formal response to your complaint — admitting, denying, or claiming ignorance of each allegation."
category: "procedure"
related:
  - "motion-to-dismiss"
  - "discovery"
...
The answer must also assert any **affirmative defenses** — legal reasons the defendant shouldn't be liable even if your allegations are true. In § 1983 cases, the most common affirmative defense is [qualified immunity](/terms-and-concepts/qualified-immunity).

## Timing

- **21 days** after service of the complaint (or 60 days if the defendant waived formal service)
- If the defendant filed a [motion to dismiss](/terms-and-concepts/motion-to-dismiss) and it was denied, **14 days** after the court's order
