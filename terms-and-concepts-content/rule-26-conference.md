...
term: "Rule 26(f) Conference"
description: "The mandatory meeting with opposing counsel to plan discovery — happens early and sets the tone for the entire case."
category: "procedure"
related:
  - "discovery"
  - "scheduling-order"
...
The Rule 26(f) conference sets the discovery framework for your entire case. The positions you take here shape the [scheduling order](/terms-and-concepts/scheduling-order) the judge enters. If you don't push for the discovery you need at this stage, you may not get it later.
