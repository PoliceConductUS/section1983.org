---
title: "Causation — Connecting Each Defendant to Your Harm"
term: "Causation"
description: "Every defendant in your § 1983 case must be personally connected to the specific constitutional violation — naming someone isn't enough."
category: "doctrine"
related:
  - "individual-capacity"
...
This is different from many areas of law where an employer is automatically liable for what employees do. In § 1983, [respondeat superior doesn't apply](/terms-and-concepts/respondeat-superior). The police department can't be liable just because it employs the officer who hurt you. The chief can't be liable just because they're in charge.
...
This connects Jones to the harm through [failure to intervene](/terms-and-concepts/failure-to-intervene) — a recognized basis for § 1983 liability.
...
This connects the supervisor to the harm through [deliberate indifference](/terms-and-concepts/deliberate-indifference) to a known pattern.
...
This is [respondeat superior](/terms-and-concepts/respondeat-superior), which doesn't work in § 1983. You need to show what the chief personally did or failed to do.
...
Departments generally aren't suable entities separate from the municipality. Sue the [city under Monell](/terms-and-concepts/monell-liability) or the [individual officers](/terms-and-concepts/individual-capacity).
...
If you've obtained [body camera footage](/terms-and-concepts/body-camera-footage), it's your best causation tool. It shows exactly who did what, when, and to whom. Reference specific timestamps in your complaint.

### 4. Name officers by name, not badge number

Courts want names. "Officer Badge #4521" is okay as a placeholder if you genuinely don't know the name yet (you can amend later after discovery), but get the real names through [FOIA requests](/process/foia-and-records-requests) before filing if possible.
...
- **Use discovery** — [interrogatories](/terms-and-concepts/interrogatories) and [requests for production](/terms-and-concepts/requests-for-production) can force the department to identify who was present and what each person did.
