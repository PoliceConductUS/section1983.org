...
title: "Demand Letter"
term: "Demand Letter"
description: "A pre-suit letter demanding compensation — not required, but it can lead to settlement without filing."
category: "procedure"
related:
  - "settlement"
...
No. You don't need to send a demand letter before filing a § 1983 case. There's no [exhaustion](/terms-and-concepts/exhaustion-of-remedies) requirement for non-prisoners. But there are strategic reasons to send one — and reasons not to.
...
- **Runs the clock** — If you're close to the [statute of limitations](/terms-and-concepts/statute-of-limitations), don't waste time on a demand letter. File first.
