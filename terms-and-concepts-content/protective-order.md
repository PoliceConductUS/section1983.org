...
description: "A court order limiting what can be shared from discovery — often used by defendants to hide embarrassing evidence."
category: "procedure"
related:
  - "discovery"
...
A protective order under Federal Rule 26(c) limits the use or disclosure of information obtained during [discovery](/terms-and-concepts/discovery). The court can issue one upon a showing of "good cause" to protect a party from "annoyance, embarrassment, oppression, or undue burden."
