---
title: "Binding Precedent"
term: "Binding Precedent"
description: "A court decision that other courts must follow — understanding which cases control in your state is critical to building your argument."
category: "procedure"
related:
...
2. **[Circuit Courts of Appeals](/terms-and-concepts/federal-circuit-courts)** — The country is divided into 13 circuits, each covering multiple states. A decision by your circuit court binds every district court in that circuit. For example, the Fifth Circuit covers Texas, Louisiana, and Mississippi — so a Fifth Circuit decision made in a Texas case is equally binding in Louisiana and Mississippi.
...
When you cite a case in your brief, the judge cares about _where_ it came from:
