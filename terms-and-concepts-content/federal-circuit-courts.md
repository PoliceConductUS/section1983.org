---
title: "Federal Circuit Courts of Appeals"
term: "Federal Circuit Courts"
description: "The 13 federal appeals courts that sit between trial courts and the Supreme Court — their decisions control the law in your state."
category: "procedure"
related:
  - "binding-precedent"
...
This matters most for [qualified immunity](/terms-and-concepts/qualified-immunity). To defeat QI, you typically need to show the right was "[clearly established](/terms-and-concepts/clearly-established-law)" at the time of the violation. Your circuit's prior decisions are the primary source for establishing that. If the Fifth Circuit has already said "you can't tase a compliant suspect during a traffic stop," then an officer in Texas, Louisiana, or Mississippi is on notice — and can't claim they didn't know.
...
1. **Three-judge panel** — Most cases are heard by a randomly assigned panel of three judges. You don't get to pick them.

2. **No new evidence** — The circuit court reviews the trial court's legal conclusions. You can't introduce new facts or witnesses. If it wasn't in the record below, it doesn't exist on appeal.

3. **Briefing** — Both sides file written briefs arguing their positions. The quality of your brief matters enormously. This is where your legal arguments live or die.

4. **Oral argument** — Not guaranteed. The court may decide your case on the briefs alone. If you get oral argument, it's usually 15-20 minutes per side.

5. **Published vs. unpublished opinions** — Published opinions become [binding precedent](/terms-and-concepts/binding-precedent) that future courts must follow. Unpublished opinions are still public but generally aren't binding (though they can be cited as persuasive authority in most circuits).

6. **En banc review** — If you lose before the three-judge panel, you can ask the full circuit (all active judges) to rehear the case "en banc." This is rarely granted — typically only when the panel decision conflicts with prior circuit precedent or raises an exceptionally important question.
...
**Watch for recent decisions.** Circuit law evolves. A case from 2023 may have overruled or narrowed a case from 2005. Always check that your cases are still good law. Free tools like [CourtListener](https://www.courtlistener.com){:target="\_blank" rel="noopener"} can help.
