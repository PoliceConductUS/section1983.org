---
title: "Younger Abstention"
term: "Younger Abstention"
description: "If you have a pending state criminal case, the federal court will almost certainly refuse to hear your § 1983 case until it's over — a trap that catches many pro se plaintiffs."
category: "doctrine"
related:
  - "heck-doctrine"
...
This comes from _Younger v. Harris_, 401 U.S. 37 (1971), where the Supreme Court held that federal courts should not enjoin ongoing state criminal proceedings except in extraordinary circumstances.
...
- If the criminal case is **still pending** when you file → Younger applies, federal case dismissed/stayed.
- If the criminal case is **already resolved** when you file → Younger doesn't apply (but watch out for the [Heck doctrine](/terms-and-concepts/heck-doctrine) if you were convicted).
- If the criminal case is **filed after** you file your § 1983 case → Younger generally doesn't apply, though some courts disagree.
...
The danger of waiting is that the [statute of limitations](/terms-and-concepts/statute-of-limitations) keeps running. In most states, § 1983 claims have a two- or three-year limitations period (borrowed from the state's personal injury statute). If your criminal case drags on for years, your § 1983 claims could expire.

Some states [toll](/terms-and-concepts/tolling) the limitations period while criminal charges are pending. Others don't. Research your state's rule — this is critical.
...
- **Bad faith prosecution** — If you can show the criminal charges were filed in bad faith specifically to harass you or retaliate for exercising your rights. This is extremely hard to prove at the federal level.
- **Patently unconstitutional statute** — If the criminal law itself is facially unconstitutional. Rare.
- **No adequate state remedy** — If the state court system genuinely cannot address your federal claims. Courts almost never find this.

## Connection to Heck

Younger and the [Heck doctrine](/terms-and-concepts/heck-doctrine) are related but different:

- **Younger** says: "Don't file while the criminal case is pending."
- **Heck** says: "If you were convicted, you can't use § 1983 to challenge the conviction unless it's been overturned."
...
Instead, use the time while the criminal case is pending to **prepare**. Gather evidence, file [FOIA requests](/process/foia-and-records-requests), research the officers' history, study your [circuit's case law](/terms-and-concepts/federal-circuit-courts), and build your [war room](/process/organizing-your-war-room). When the criminal case resolves, you'll be ready to file a strong § 1983 complaint immediately.
