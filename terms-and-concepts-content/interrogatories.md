...
description: "Written questions the other side must answer under oath — limited to 25 in federal court, so make them count."
category: "procedure"
related:
  - "discovery"
  - "motion-to-compel"
...
- **State the factual basis** for each affirmative defense (especially [qualified immunity](/terms-and-concepts/qualified-immunity))
...
Your remedy: [motion to compel](/terms-and-concepts/motion-to-compel). Document the deficient response, meet and confer, then ask the court to order a real answer.
