---
title: "Intracorporate Conspiracy Doctrine"
term: "Intracorporate Conspiracy Doctrine"
description: "A legal rule that says employees of the same organization can't 'conspire' with each other — and a major obstacle when suing multiple officers from the same department."
category: "doctrine"
related:
...
This defense comes up in both [§ 1983 conspiracy claims](/terms-and-concepts/section-1983-conspiracy) and [§ 1985(3) claims](/terms-and-concepts/section-1985).
...
- The Fifth Circuit has generally applied the doctrine to § 1985(3) claims against officers in the same department.
- The Eleventh Circuit has applied it in some contexts.

**Circuits that limit or reject it:**

- Several circuits recognize a **personal stake exception** — if an officer had an independent personal motivation (like covering up their own misconduct), they can be treated as acting outside their employment role and thus capable of conspiring.
- Some circuits hold the doctrine doesn't apply to § 1983 conspiracy claims at all, only to § 1985(3).
- The scope exception: officers acting **outside** the scope of their employment can conspire even under the doctrine.
...
**5. Pursue the Monell claim instead.** If the conspiracy doctrine blocks your claim against individual officers, the coordinated conduct itself may support a [Monell claim](/terms-and-concepts/monell-liability) against the municipality — arguing the department had a custom or policy of tolerating this kind of coordinated misconduct.
...
**Org charts and municipal codes.** Request the city's organizational chart through [FOIA/public records requests](/process/foia-and-records-requests). Review the municipal code to see how departments are legally structured. Some cities keep departments as separate legal entities (which defeats the doctrine); others consolidate everything under the city manager.
...
1. **It strengthens your [Monell claim](/terms-and-concepts/monell-liability).** The organizational structure itself becomes evidence of a policy or custom designed to insulate misconduct from accountability. A city that structures its government to make conspiracy claims impossible has arguably created a policy of tolerating coordinated violations.
...
Also, even if a court applies the doctrine, it only blocks the _conspiracy_ claim. Your underlying § 1983 claims against each individual officer survive. The conspiracy theory is an additional tool — losing it doesn't sink your case.
