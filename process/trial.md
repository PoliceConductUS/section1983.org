---
title: "Trial"
description: "You present your evidence to a judge or jury. You go first. Nothing like TV."
order: 11
movant: "Plaintiff presents first"
respondent: "Defendant follows"
stage: "trial"
tags: ["trial", "jury", "evidence", "testimony"]
---
...
- **Peremptory** — you don't need a reason, but you can't strike based on race or gender (_Batson v. Kentucky_). Limited number (typically 3 per side in civil cases).
...
1. **Direct examination** — you ask questions (open-ended: who, what, when, where, why, how)
2. **Cross-examination** — defense attorney questions your witness (leading questions allowed)
3. **Redirect** — you can ask follow-up questions to clarify anything raised on cross

For each exhibit:

1. **Lay foundation** — establish what the exhibit is through witness testimony
2. **Authenticate** — prove it's genuine (FRE 901)
3. **Move to admit** — ask the court to admit it into evidence
4. **Publish to jury** — show it to the jury
