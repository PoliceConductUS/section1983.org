...
description: "Before you file anything, you need evidence. FOIA requests, body camera footage, statistical data, and an organized case file are the foundation of a complaint that survives."
order: 1
movant: "You (not yet a plaintiff)"
respondent: "Government agencies (records custodians)"
stage: "pre-filing"
tags: ["preparation", "foia", "evidence", "getting-started", "organization"]
---
...
**The critical insight**: most of this evidence is available through public records requests _before_ you file suit. Once you file, agencies often become less cooperative, and you'll have to fight for records through formal [discovery](/process/discovery) — a slower, more adversarial process. Get what you can now.

This stage has two parts:

1. **[Gathering your evidence](/process/foia-and-records-requests)** — FOIA requests, body camera footage, statistical data
2. **[Organizing your war room](/process/organizing-your-war-room)** — folder structure, strategy documents, case timeline
...
Before you file, **[stress-test your case](/articles/how-to-stress-test-your-case-before-filing)** — tear apart your own complaint the way the defense will. Every claim that survives your own scrutiny will be stronger when it faces theirs.
...
>
> 1. All **body-worn camera footage** from every officer present at or responding to the incident, including pre-event buffer recordings
> 2. All **dashboard camera footage** from every vehicle dispatched to or present at the scene
> 3. All **dispatch audio recordings** and **Computer-Aided Dispatch (CAD) logs** related to the incident, including the initial call and all dispatched units
...
> 5. All **photographs and video** taken by any officer or department employee at the scene, during transport, or during booking
> 6. All **booking records**, including intake photographs, medical screening forms, and property inventories
> 7. All **communications** — including emails, text messages, radio transmissions, and internal messaging — between any officers, supervisors, or department personnel regarding the incident or regarding **[your name]**
> 8. All **internal affairs complaints, investigations, and disciplinary records** for the involved officers for the past **five years**
> 9. All **training records** for the involved officers, including use-of-force training, de-escalation training, First Amendment training, and body camera policy training
> 10. All **department policies and procedures** in effect on the date of the incident, including use-of-force policy, arrest policy, body camera policy, and citizen complaint policy
> 11. All **surveillance camera footage** from fixed cameras in the area of the incident
> 12. All **records related to prior § 1983 lawsuits** or civil rights complaints against the involved officers
>
...
Start with **[gathering your evidence](/process/foia-and-records-requests)** — the FOIA requests that will form the backbone of your complaint.
