---
title: "Interlocutory Appeal"
description: "When a court denies qualified immunity, defendants can appeal immediately — freezing your case for 6-18 months. This is the single most effective delay weapon in § 1983 litigation."
order: 9
movant: "Defendant"
respondent: "Plaintiff (you defend in the circuit court)"
stage: "appeal"
tags: ["interlocutory-appeal", "qualified-immunity", "delay", "critical"]
---
...
1. Defendant's QI motion is denied by the district court
2. Defendant files a notice of appeal in the circuit court (typically within 30 days)
3. The district court case is **automatically stayed** in most circuits — everything stops
4. Briefing in the circuit court: defendant's brief → your brief → defendant's reply
5. The circuit court decides (sometimes with oral argument, often on the briefs)
6. If QI is granted: case dismissed (or claim dismissed). If affirmed: case resumes in district court.
...
Under _Johnson v. Jones_ (1995), the circuit court lacks jurisdiction over interlocutory appeals that turn on disputes of fact rather than questions of law. The distinction matters:
...
But defendants routinely file interlocutory appeals that are really factual disputes dressed up as legal questions. They know the circuit court _should_ dismiss for lack of jurisdiction — but the filing itself causes delay. Even a jurisdictional dismissal takes months.
...
If the appeal raises factual disputes, file a motion in the circuit court arguing it lacks jurisdiction under _Johnson v. Jones_. Be specific: identify exactly which facts are disputed and explain why the appeal can't be resolved without resolving those disputes.
...
The system knows this. It hasn't fixed it. _Behrens v. Pelletier_ (1996) explicitly confirmed that defendants can file a second interlocutory appeal at summary judgment even if they already appealed at Rule 12. The Court acknowledged the burden but said the right to immunity outweighed it.
