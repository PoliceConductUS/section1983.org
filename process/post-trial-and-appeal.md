...
description: "After the verdict: motions for new trial, fee petitions, and the final appeal. The 30-day notice deadline is jurisdictional — miss it and it's over."
order: 12
movant: "Either party"
respondent: "Opposing party"
stage: "post-trial"
tags: ["post-trial", "appeal", "fees", "rule-59", "rule-60"]
---
...
If _you_ lost, you can file a Rule 50(b) motion too — but only if you moved for judgment as a matter of law during trial. If you didn't make the motion during trial, you can't make it after.
...
The law here is less favorable. Under _Kay v. Ehrler_ (1991), pro se plaintiffs who are not attorneys generally **cannot** recover attorney's fees under § 1988. The rationale: § 1988 is designed to incentivize lawyers to take civil rights cases, not to compensate pro se litigants.
...
1. **Record on appeal** — the district court clerk transmits the trial record to the circuit court
2. **Briefing**: Opening brief (appellant) → Response brief (appellee) → Reply brief (appellant)
3. **Oral argument** — not guaranteed. The court may decide on the briefs alone.
4. **Decision** — the circuit court issues an opinion
